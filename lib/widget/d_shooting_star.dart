...
class DStarPainter extends CustomPainter {
  @override
  void paint(Canvas canvas, Size size) {
    ...
    final Paint paint = Paint()
      ...
      ..strokeWidth = 3
      ..shader = gradient.createShader(const Rect.fromLTRB(0, -256, 128, 0)); // 선이 그려지는 영역으로 Rect 설정
    ...
    final Paint glowPaint = Paint()
      ..color = const Color.fromARGB(187, 255, 235, 59)
